...
/* harmony default export */ __webpack_exports__["default"] = (async function ({
  ...
  const pointerlock = true; // Wait for the project to finish loading. Renderer and scripts will not be fully available until this happens.
  ...
  const handleGamepadMouseMove = e => {
    ...
    if (pointerlock) {
      ...
      const zoomMultiplierY = rectHeight / vm.runtime.stageHeight; // This is defined in pointerlock addon
